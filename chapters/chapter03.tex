...
à la fois des utilisateurs et des logiciels anti-virus. \cite{virus} %vérifié
    ...
    rend plus difficile à détecter par les anti-virus. \cite{virus} %vérifié
    ...
    à une autre ? \cite{virus} %vérifié
        ...
        des mécanismes de détections qui sont indépendantes du code du virus. On y trouve : \cite{virus} %vérifié
        \begin{description}
        ...
        Il a été suggérer une fois que les systèmes peuvent être vaccinés contre des virus spécifiques en simulant
        l'indicateur d'auto-détection du virus sur des systèmes non infectés. 
        Malheureusement, il y a trop de virus pour que ça soit faisable. \cite{virus} %vérifié
        ...
        \begin{description}
            \item[Instructions équivalentes :] En assembleur, il y a souvent des instructions élémentaires qui ont 
                le même effet. Exemple : les instructions suivantes mettent toutes le registre \verb|ax| à zéro. %vérifié
                \begin{verbatim}
                    clear ax
                    xor ax
                    and ax, 0
...
% Petite introduction ici.
        ...
        son éradication impossible. %vérifié
        ...
        celle-ci s’ajuste à la taille du code viral. %vérifié
        ...
        d'entrée du programme et insère tout ou partie de son code dans différentes zones non utilisées. %vérifié
        ...
        s’y situent sont inchangés. %vérifié
        ...
        original pour ne pas risquer d’alerter l’utilisateur. %vérifié
        ...
        la main au programme initial. %vérifié
        ...
        la taille des programmes possible. %vérifié
...
% pas sur de la phrase.
    ...
    d'autre informations vitale. \cite{pe3} %vérifié
    ...
    une structure de données appeler \emph{\textsc{image\_nt\_headers}} dont les champs sont : %vérifié
    \begin{description}
